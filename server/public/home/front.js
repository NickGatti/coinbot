...
let popOrderPlacementData = ( () => {
    docBuyStateID.innerHTML = pageData.buyState ?
        docBuyStateID.innerHTML = pageData.buyState.charAt( 0 )
        .toUpperCase() + pageData.buyState.slice( 1 ) :
    ...
    docSellStateID.innerHTML = pageData.sellState ?
        pageData.sellState.charAt( 0 )
        .toUpperCase() + pageData.sellState.slice( 1 ) :
...
let popBuyData = ( () => {
    ...
    docDifferenceBuy.innerHTML = pageData.buyOrderData.orderUpdate ?
        '$' + ( pageData.buyOrderData.myBuyOrder.price - pageData.buyOrderData.myBuyOrder.oldPrice )
        .toFixed( 2 ) :
    ...
    if ( pageData.buyOrderData.myBuyOrder ) {
        ...
        docTotalBuy.innerHTML = 20 * pageData.buyOrderData.myBuyOrder.price ?
            '$' + numberWithCommas( ( 20 * pageData.buyOrderData.myBuyOrder.price )
                .toFixed( 2 ) ) :
...
let popSellData = ( () => {
    if ( pageData.sellOrderData.mySellOrder ) {
        ...
        docTotalSell.innerHTML = 20 * pageData.sellOrderData.mySellOrder.price ?
            '$' + numberWithCommas( ( 20 * pageData.sellOrderData.mySellOrder.price )
                .toFixed( 2 ) ) :
